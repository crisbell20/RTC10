...
<head>
    ...
    <title><?= $resultId ? 'Exam Result Details' : 'My Results' ?> - PNP RTC X</title>
...
<body>
    <div class="top-nav">
        <div class="nav-brand">
            ...
            <p><?= $resultId ? 'Exam Result Details' : 'My Results' ?></p>
        </div>
        <div class="nav-user">
    ...
    <div class="dashboard-container">
        ...
        <div class="sidebar">
            <ul class="sidebar-menu">
                <li><a href="../examinee/dashboard.php"><i class="bi bi-grid-1x2-fill"></i>Dashboard</a></li>
                <li class="menu-label"><i class="bi bi-folder-fill"></i>Masterfiles</li>
                <li><a href="../examinee/dashboard.php#available-exams"><i class="bi bi-pencil-square"></i>Take Exam</a></li>
                <li><a href="result.php" class="active"><i class="bi bi-clipboard-check"></i>Results</a></li>
                <li><a href="perfomance.php"><i class="bi bi-graph-up"></i>Performance</a></li>
                <li><a href="schedule.php"><i class="bi bi-calendar-event"></i>Schedule</a></li>
        ...
        <div class="main-content">
            ...
            <?php if (!$resultId): ?>
            <!-- Results List View -->
            <div id="resultsListContent" style="display: none;">
                <div class="page-header mb-4">
                    <h2>My Exam Results</h2>
                    <p class="text-muted">View your completed exam results and performance</p>
                </div>
            ...
            <div id="questionsContent" style="display: none;">
                <div class="section-card">
                    ...
                    <div class="section-body" id="questionsList"></div>
                </div>
            </div>
            <?php endif; ?>
        </div>
    ...
    <script>
        ...
        function loadResultsList() {
            axios.get('../../api/examinee/dashboard.php?action=all-results')
                .then(response => {
                    if (response.data.success) {
                        displayResultsList(response.data.data || []);
                    } else {
                        showError(response.data.message || 'Failed to load results');
                    }
                })
                .catch(error => {
        ...
        function displayResultsList(results) {
            ...
            document.getElementById('resultsListContent').style.display = 'block';
            
            if (!results || results.length === 0) {
                document.getElementById('resultsList').innerHTML = '<p class="text-center text-muted py-5">No exam results yet</p>';
                return;
            }
                    ...
                    <div class="result-card" ${canView ? `onclick="window.location.href='result.php?result_id=${result.Result_ID}'"` : 'style="cursor: default;" title="Response review is disabled for this exam"'}>
                        <div class="d-flex justify-content-between align-items-start">
                            <div class="flex-grow-1">
                                ...
                                <p class="text-muted mb-2">${result.Subject_Name ? escapeHtml(result.Subject_Name) : 'N/A'}</p>
                            ...
                            <div class="text-end">
                                ...
                                <h3 class="mb-0">${percentage.toFixed(1)}%</h3>
                                <small class="text-muted">${result.Score}/${result.total_questions}</small>
                            </div>
                        </div>
                    </div>
                `;
